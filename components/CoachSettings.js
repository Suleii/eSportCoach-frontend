    ...
    <div className="flex flex-col items-center min-h-screen text-white">
      <div className='w-5/6 flex-1 '>
        <form onSubmit={handleSubmit}  encType="multipart/form-data" >
          <div className='flex flex col justify-center mb-8 w-full '>
            {/* Profile picture to upload */}
              <div className="w-28 h-28 bg-base-200  rounded-full"
        ...
        <div className='mt-6 '>
          ...
          <div className="flex mb-2 w-full">
            ...
            <div className="flex flex-wrap mb-2">
                {language.map((language, index) => (
                    <div key={index} className="bg-base-100  h-8 rounded-xl p-2 m-1 flex items-center justify-center">
          ...
          <div className="flex mb-2 w-full">
            ...
            <div className="flex flex-wrap mb-2">
                {games.map((game, index) => (
                    <div key={index} className="bg-accent  h-8 rounded-xl p-2 m-1 flex items-center justify-center">
          ...
          {isEditing && (
            <>
              <button className='bg-primary-content w-36  rounded-xl p-2 mb-6' type="button" onClick={handleCancelClick}>
                Cancel
              </button>
              <button className='bg-success w-36 rounded-xl p-2 mb-6' type="button" onClick={handleSaveClick}>
                Save
              </button>
            </>
          )}
