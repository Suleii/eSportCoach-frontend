...
return (
    ...
    <div className='w-5/6 flex-1'>
        ...
        <label className="form-control lg:w-2/3 xl:w-2/3 w-full mb-4">
            ...
            <input type="text" placeholder="Your name" className="input input-bordered" onChange={handleNameChange}/>
        </label>
        <label className="form-control lg:w-2/3 xl:w-2/3 w-full mb-4">
            <div className="label">
                <span className="label-text text-white mb-2">Email</span>
            </div>
            <input type="text" placeholder="Your email address" className="input input-bordered" onChange={handleEmailChange}/>
        </label>
        <label className="form-control lg:w-2/3 xl:w-2/3 w-full mb-4">
            <div className="label">
                <span className="label-text text-white mb-2">Subject</span>
            </div>
            <input type="text" placeholder="Subject" className="input input-bordered" onChange={handleSubjectChange} />
        </label>
        <label className="form-control">
            <div className="label">
                <span className="label-text text-white mb-2">Message</span>
            </div>
            <textarea placeholder="How can we help?" className="textarea textarea-bordered textarea-lg h-56" onChange={handleMessageChange}></textarea>
        </label>

        <p className='mt-4 text-accent'>{error}</p>
        <div className='flex w-full justify-end mt-10'>
        <input type="submit" value="Submit" className="btn btn-success text-white" onClick={handleSubmit} />
        </div>
    </div>
    </div>
)
