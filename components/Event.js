...
function Event(props) {
  ...
  const handleCancel = () => {
    fetch("https://experience-backend.vercel.app/bookings", {
      method: "DELETE",
      ...
      .then((data) => {
        ...
        fetch(
          "https://experience-backend.vercel.app/emails/bookingCancellation",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
          ...
          .then((emailConfirmation) => {
            console.log("Email cancellation sent:", emailConfirmation);
          })
          .catch((error) => {
        ...
        <div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="dropdown dropdown-left">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content z-[1] menu  bg-white rounded-box w-44 h-9 justify-center mr-2 align-center"
              >
                <li onClick={handleCancel} className="text-accent text-sm">
                  <a>Cancel this session</a>
                </li>
              </ul>
            </div>
          </div>
